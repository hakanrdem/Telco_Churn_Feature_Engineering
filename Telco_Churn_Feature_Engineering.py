...
df = pd.read_csv("dsmlbc_9_abdulkadir/Homeworks/hakan_erdem/5_Özellik_Mühendisliği/Telco_Churn_Feature_Engineering/Telco-Customer-Churn.csv")
df.head()
df.shape
df.info()
...
# Adım 4
# Hedef değişken analizi yapınız. (Kategorik değişkenlere göre hedef değişkenin
